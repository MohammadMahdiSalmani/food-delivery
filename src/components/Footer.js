    ...
    return (
        <footer className='flex flex-col w-full justify-around py-10 min-h-56 border-t-2 border-lightGray my-10'>
            <div className='flex w-full justify-around text-gray'>
                <div className='flex flex-col w-1/3 justify-around text-center'>
            ...
            <p className='flex justify-center self-center  w-11/12 text-sm'>© 2017 - 2024 McDonald's. All Rights Reserved</p>
        </footer>
    )
}
