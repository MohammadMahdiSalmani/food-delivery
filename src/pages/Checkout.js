...
const Checkout = () => {
    ...
    return (
        ...
        <section className='flex flex-col items-center w-full'>
            <h2 className='flex w-11/12 justify-start text-5xl mb-4'>Delivery</h2>
            <Card className='flex flex-col w-11/12 rounded-2xl' title="Address Details" bordered={false}>
            ...
            <Card className='flex flex-col w-11/12 rounded-2xl mt-8' title="Delivery Method" bordered={false}>
