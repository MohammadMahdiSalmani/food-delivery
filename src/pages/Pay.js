...
const Pay = () => {
    ...
    return (
        <section className='flex flex-col items-center w-full min-h-screen'>
            <h2 className='flex w-11/12 lg:w-2/3 justify-start text-5xl mb-4'>Payment</h2>

            <Card className='flex flex-col w-11/12 lg:w-2/3 rounded-2xl' title="Payment method" bordered={false}>
            ...
            <div className='flex justify-between w-5/6 lg:w-1/2 py-6'>
            ...
            <Link to="/"><Button type='primary' className='fixed bottom-2 left-1/2 -translate-x-1/2 w-11/12 lg:w-1/2 h-auto text-xl py-2 rounded-xl bg-primary'>Pay</Button></Link>
